...
public class TormentedSoulImpactState : TormentedSoulBaseState
{
    ...
    public TormentedSoulImpactState(TormentedSoulStateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        if (duration <= 0.0f)
        {
            stateMachine.SwitchState(new TormentedSoulIdleState(stateMachine));
        }
    }
